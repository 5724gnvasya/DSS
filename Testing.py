...
model.classifier.weight = torch.load('classifier_weight.pt')
model.classifier.bias = torch.load('classifier_bias.pt')
...
#     print("The predicted label is negative.")
# elif predicted_label == 1:
#     print("The predicted label is positive.")
# else:
